...
class PostViewHolder(
    ...
    fun bind(post : Post) {
        binding.apply {
            ...
            imgbLiked.setOnClickListener { onInteractionListener.onLike(post)
            }

            imgbShare.setOnClickListener {onInteractionListener.onShare(post)
            }

            imgbWatch.setOnClickListener {onInteractionListener.onWatch(post)
            }
